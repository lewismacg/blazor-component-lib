...
namespace BlazorComponents
{
	...
	public partial class Banner
	{
		...
		protected bool BannerHidden { get; set; }
		...
		protected override void OnAfterRender(bool firstRender)
		{
			if (firstRender)
			{
				...
				if (DepthForDisplay.HasValue) Runtime.InvokeVoidAsync("ScrollElement.showOnScroll", $"row-{BannerId}", "translucent", DepthForDisplay);
				StateHasChanged();
			}
