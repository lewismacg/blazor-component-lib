// Be aware this is a custom edited datepicker originally forked from codepen.io/incentive/pen/KKqvrjj.
// Edits have been made to add event handling interop with blazor as well as initialising from IJSRuntime.
...
(function () {
    ...
    function _parseDate(dateStr, format, locale) {
        if (_instanceof(dateStr, Date) || typeof dateStr === 'number') {
    ...
    function replaceChildNodes(el, newChildNodes) {
        ...
        if (_instanceof(newChildNodes, DocumentFragment)) {
    ...
    function triggerDatepickerEvent(datepicker, type) {
        ...
        if (type === 'changeDate') {
            var modelValue = detail.date;
            datepicker.element.dispatchEvent(new CustomEvent('change', {
    ...
    var Datepicker = /*#__PURE__*/function () {
        ...
        _createClass(Datepicker, [{
            ...
            value: function setDate() {
                ...
                if (_typeof(lastArg) === 'object' && !Array.isArray(lastArg) && !_instanceof(lastArg, Date) && lastArg) {
...
DatePicker.initialize = function (classname, label) {
