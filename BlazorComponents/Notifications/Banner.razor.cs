...
namespace BlazorComponents
{
	...
	public partial class Banner
	{
		...
		private Colour DiscernIconColour(NotificationType notificationType)
		{
			...
			{
				NotificationType.Info => Colour.Black,
				NotificationType.Warning => Colour.Black,
				NotificationType.Error => Colour.Black,
				NotificationType.Success => Colour.White,
		...
		private string DiscernIconName(NotificationType notificationType)
		{
			return notificationType switch
			{
				NotificationType.Info => "notifications_none",
				NotificationType.Warning => "help_outline",
				NotificationType.Error => "info_outline",
