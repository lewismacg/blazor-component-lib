...
namespace BlazorComponents
{
	...
	{
		private static ConditionalWeakTable<Dispatcher, SectionRegistry> _registries = new ConditionalWeakTable<Dispatcher, SectionRegistry>();

		private Dictionary<string, List<Action<RenderFragment>>> _subscriptions = new Dictionary<string, List<Action<RenderFragment>>>();
