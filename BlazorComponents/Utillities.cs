...
namespace BlazorComponents
{
	internal static class Utilities
	{
		...
		/// <summary>
		/// Converts a string to a more readable sentence, i.e. TestName to Test Name
		/// </summary>
		/// <param name="input"></param>
		/// <returns></returns>
		public static string ToSentence(this string input) => new(input.SelectMany((c, i) => i > 0 && char.IsUpper(c) ? new[] { ' ', c } : new[] { c }).ToArray());

		/// <summary>
		/// Converts a decimal to it's £ equivalent format.
		/// </summary>
